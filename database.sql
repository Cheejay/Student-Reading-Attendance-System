...
--
-- Host: localhost:3306
-- Generation Time: Oct 31, 2017 at 02:07 PM
...
(162, 0, 1, 1, 10000, 'excel', 'index', 'index', '', 'EXCEL导入导出', 'file-excel-o', '');
...
(162, 1, 'excel', 'admin_url', 'excel/index/index', '', 'EXCEL导入导出', '');
...
(7, 1, 'site_info', '{\"site_name\":\"\\u73e0\\u6d77\\u4e00\\u804c\\u9605\\u8bfb\\u5427\",\"site_seo_title\":\"\\u73e0\\u6d77\\u4e00\\u804c\\u9605\\u8bfb\\u5427\",\"site_seo_keywords\":\"\\u73e0\\u6d77\\u4e00\\u804c\",\"site_seo_description\":\"\"}');
...
CREATE TABLE `cmf_user` (
  ...
  `user_nickname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户姓名',
  `user_email` varchar(100) NOT NULL DEFAULT '' COMMENT '用户登录邮箱',
  `class` varchar(100) NOT NULL DEFAULT '' COMMENT '班级',
  `avatar` varchar(255) NOT NULL DEFAULT '' COMMENT '用户头像',
  `student_number` int(18) DEFAULT NULL COMMENT '学号',
  `last_login_ip` varchar(15) NOT NULL DEFAULT '' COMMENT '最后登录ip',
  `user_activation_key` varchar(60) NOT NULL DEFAULT '' COMMENT '激活码',
  `mobile` varchar(20) NOT NULL DEFAULT '' COMMENT '用户手机号',
  `more` text COMMENT '扩展属性',
  `user_url` varchar(45) DEFAULT NULL,
...
INSERT INTO `cmf_user` (`id`, `user_type`, `sex`, `birthday`, `last_login_time`, `score`, `coin`, `create_time`, `user_status`, `user_login`, `user_pass`, `user_nickname`, `user_email`, `class`, `avatar`, `student_number`, `last_login_ip`, `user_activation_key`, `mobile`, `more`, `user_url`, `signature`) VALUES
(1, 1, 0, 0, 1509342130, 0, 0, 0, 1, 'admin', '###8d1d2ff0e34e6bf9270a18c4a0cba2fe', 'admin', 'admin@zhyz.xyz', 'admin', '', 1620100000, '10.11.123.160', '', '', 'admin', NULL, NULL);
...
(3, 1, 1524624780, 1509072780, '8d72fc1764bbbd663981270273df360e8666fbd2ea9728e40623d7bf7f3250a5', 'web');
...
--
ALTER TABLE `cmf_auth_rule`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键', AUTO_INCREMENT=163;
--
